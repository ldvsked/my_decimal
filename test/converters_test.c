...
START_TEST(test_s21_decimal_converters_int_to_decimal_int_min){
    ...
    s21_decimal my_dec;
    unsigned int expected_dec[4] = {(unsigned int)(-(long long)INT_MIN), 0, 0, 1u << 31};
...
START_TEST(test_s21_decimal_converters_decimal_to_int_int_min){
    s21_decimal input_dec = { .bits = {(unsigned int)(-(long long)INT_MIN), 0, 0, 1u << 31}};
...
START_TEST(test_s21_decimal_converters_decimal_to_int_overflow_negative){
    s21_decimal input_dec = { .bits = {(unsigned int)(-(long long)INT_MIN) + 1u, 0, 0, 1u << 31}};
    int my_int = 0;
...
START_TEST(test_s21_decimal_converters_decimal_to_int_scale_negative){
    s21_decimal input_dec = { .bits = {567, 0, 0, (1 << 16) | (1u << 31)}}; // scale = 1, знак = минус
...
START_TEST(test_s21_decimal_from_decimal_to_float_negative_fraction) {
    s21_decimal input = {.bits = {1234567, 0, 0, (4 << 16) | (1u << 31)}}; // scale=4, знак минус
...
START_TEST(test_s21_decimal_from_decimal_to_float_max) {
    s21_decimal input = {.bits = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0}}; // scale = 0
...
START_TEST(test_s21_decimal_from_decimal_to_float_min_negative) {
    s21_decimal input = {.bits = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 1u << 31}}; // знак минус, scale=0
...
START_TEST(test_s21_decimal_from_decimal_to_float_one_scale_28) {
    s21_decimal input = {.bits = {1000000000, 0, 0, 9 << 16}}; // scale = 9 → 1e-9 * 1e9 = 1
    float expected = 1.0f;
    float result;
    ck_assert_int_eq(0, s21_from_decimal_to_float(input, &result));
...
Suite* test_s21_decimal_converters_suite(void){
    ...
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_normal);
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_zero);
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_one);
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_minus_one);
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_int_max);
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_int_min);
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_large_positive);
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_large_negative);
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_small_positive);
    tcase_add_test(tc_int_to_dec, test_s21_decimal_converters_int_to_decimal_small_negative);

    TCase* tc_dec_to_int = tcase_create("from_dec_to_int");
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_normal);
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_scale_nonzero);
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_bits1_nonzero);
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_bits2_nonzero);
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_int_max);
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_int_min);
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_overflow_positive);
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_overflow_negative);
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_scale_negative);
    tcase_add_test(tc_dec_to_int, test_s21_decimal_converters_decimal_to_int_zero_scale);

    TCase* tc_float_to_dec = tcase_create("from_float_to_dec");
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal);
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal_zero);
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal_negative);
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal_small_positive);
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal_too_small);
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal_too_large);
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal_precision);
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal_negative_small);
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal_integer_float);
    tcase_add_test(tc_float_to_dec, test_s21_decimal_converters_from_float_to_decimal_fraction_large);

    TCase* tc_decimal_to_float = tcase_create("from_decimal_to_float");
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_converters_from_decimal_to_float_normal);
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_from_decimal_to_float_zero);
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_from_decimal_to_float_positive_int);
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_from_decimal_to_float_positive_fraction);
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_from_decimal_to_float_negative_int);
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_from_decimal_to_float_negative_fraction);
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_from_decimal_to_float_max);
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_from_decimal_to_float_min_negative);
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_from_decimal_to_float_max_scale);
    tcase_add_test(tc_decimal_to_float, test_s21_decimal_from_decimal_to_float_one_scale_28);
