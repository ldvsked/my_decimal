...
// START_TEST(test_s21_add_max_decimal) {
//     ck_assert_int_eq();
//     ck_assert_int_eq();
//     ck_assert_int_eq();
// }
...
// START_TEST(test_s21_add_min_decimal) {
//     ck_assert_int_eq();
//     ck_assert_int_eq();
//     ck_assert_int_eq();
// }
...
//   tcase_add_test(tc, test_s21_add_max_decimal);
//   tcase_add_test(tc, test_s21_add_min_decimal);
  return tc;
}
...
//   suite_add_tcase(s, create_comparisons_tcase());
//   suite_add_tcase(s, create_..._tcase());
